...
class registerUserForm(ModelForm):
    ...
    password1 = forms.CharField(label="Password", widget=forms.PasswordInput, min_length=1, max_length=20, required=True,)
    password2 = forms.CharField(label="Repeat Password", widget=forms.PasswordInput, min_length=1, max_length=20, required=True,)
